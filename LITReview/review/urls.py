...
urlpatterns = [
    ...
    # path('view_review', views.display_reviews, name='view_review'),
    ...
    # path('review_with_ticket/<int:id_ticket>/<int:id_review>', views.create_review_ticket, name='review_with_ticket'),
